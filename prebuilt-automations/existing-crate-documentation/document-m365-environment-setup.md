...
The "Document M365 Environment" crate is a handy automation tool designed to streamline the documentation of all related information to the Microsoft 365 environment. It records details such as total users, disabled, enabled, synced, licenced etc as well as all members of priveleged groups - ensuring that all changes are recorded as part of the version history.
...
The automation fetches user details from the Microsoft 365 API and documents this information on your ITGlue platform.
